...
from app.core.research_service.schemas.fact_checker_schema import FactCheckResults
from app.core.research_service.schemas.github_analyser_schema import ProjectAnalysis
from app.core.research_service.schemas.news_researcher_schema import NewsFindings
from app.core.research_service.schemas.research_brief_schema import ResearchBrief
from app.core.research_service.schemas.trend_analyser_schema import TrendData
