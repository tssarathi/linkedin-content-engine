from app.content_agent.prompts.strategist_instruction import (
    DESCRIPTION as STRATEGIST_DESCRIPTION,
    INSTRUCTION as STRATEGIST_INSTRUCTION,
)
from app.content_agent.prompts.copywriter_instruction import (
    DESCRIPTION as COPYWRITER_DESCRIPTION,
    INSTRUCTION as COPYWRITER_INSTRUCTION,
)
from app.content_agent.prompts.editor_instruction import (
    DESCRIPTION as EDITOR_DESCRIPTION,
    INSTRUCTION as EDITOR_INSTRUCTION,
)
from app.content_agent.prompts.optimizer_instruction import (
